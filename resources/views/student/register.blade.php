...
<head>
    ...
    <title>Daftar Siswa - Spatial Working Memory Test</title>
...
<body>
    <main class="page">
        <section class="card" aria-label="Form Daftar Siswa">
            <h1>Daftar Siswa</h1>
            <p class="subtitle">Spatial Working Memory Test</p>

            <a class="google-btn" href="{{ route('student.google') }}" aria-label="Daftar siswa dengan Google">
            ...
            <form action="{{ route('student.register.process') }}" method="post">
                ...
                <div class="field">
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Masukkan nama siswa" required>
                </div>
                ...
                <div class="field">
                    ...
                    <input id="email" name="email" type="email" value="{{ old('email') }}" placeholder="Masukkan email siswa" required>
                </div>
                ...
                <button class="btn" type="submit">Daftar sebagai siswa</button>
            </form>

            <div class="actions">
                <a class="btn secondary" href="{{ route('student.login') }}">Sudah punya akun? Login<span class="register-highlight">Masuk</span></a>
            </div>
        </section>
    </main>
</body>
