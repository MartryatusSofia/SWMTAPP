...
<head>
    ...
    <title>Login Siswa - Spatial Working Memory Test</title>
...
<body>
    <main class="page">
        <section class="card" aria-label="Form Login Siswa">
            <h1>Login Siswa</h1>
            <p class="subtitle">Spatial Working Memory Test</p>

            <a class="google-btn" href="{{ route('student.google') }}" aria-label="Login siswa dengan Google">
            ...
            <div class="actions">
                <a class="btn secondary" href="{{ route('student.register') }}">Daftar sebagai siswa? <span class="register-highlight">Register</span></a>
            </div>
        </section>
    </main>
</body>
