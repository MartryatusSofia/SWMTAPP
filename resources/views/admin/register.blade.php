...
<head>
    ...
    <title>Daftar Guru - Spatial Working Memory Test</title>
...
<body>
    <main class="page">
        <section class="card" aria-label="Form Daftar Guru">
            <h1>Daftar Guru</h1>
            <p class="subtitle">Spatial Working Memory Test</p>

            <a class="google-btn" href="{{ route('auth.google') }}" aria-label="Daftar dengan Google">
            ...
            <p class="section-title">Daftar dengan Email</p>

            @if ($errors->any())
                <p class="alert error">{{ $errors->first() }}</p>
            @endif

            <form action="{{ route('teacher.register.process') }}" method="post">
                @csrf
                ...
                <div class="field">
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Masukkan nama guru" required>
                </div>
                ...
                <div class="field">
                    ...
                    <input id="email" name="email" type="email" value="{{ old('email') }}" placeholder="Masukkan email aktif" required>
                </div>
                ...
                <button class="btn" type="submit">Daftar sebagai guru</button>
            </form>

            <div class="actions">
                <a class="btn secondary" href="{{ route('teacher.login') }}">Sudah punya akun?&nbsp;<span class="login-highlight">Login</span></a>
            </div>
        </section>
    </main>
</body>
